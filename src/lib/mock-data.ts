...
export const PHASES: Phase[] = [
  ...
  {
    id: 'phase4', num: '4', title: 'Soft Landscaping', date: 'September 2026', status: 'upcoming',
    tasks: [
      { id: 'p4t1',  text: 'Confirm all hard landscaping traffic across lawn zone is finished',             done: false },
      { id: 'p4t2',  text: 'Rake settled topsoil, work in ~1000L compost to top 100–150mm',                 done: false },
      { id: 'p4t3',  text: 'Stale seedbed: leave 10 days, then hoe off weed flush',                         done: false },
      { id: 'p4t8',  text: 'Fine levelling: screed board on string lines, fill dips, heel firm, cross-rake', done: false },
      { id: 'p4t9',  text: 'Set EverEdge 5–10mm below finished grass level',                                done: false },
...
export const BUDGET_ITEMS: BudgetItem[] = [
  ...
  { id: 'turf',       name: 'Lawn Seed + Topsoil + Fertiliser',          low:   95, high:  215 },
...
export const ZONES: Zone[] = [
  ...
  },
  {
    ...
    desc: 'Level lawn (cut-and-fill). EverEdge steel edging on sweeping curved boundary. Seeded September 2026 (hard-wearing RPR mix). Swing set on left.',
  },
  {
    id: 'zone3',
